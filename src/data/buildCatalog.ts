import { mapApiRarity } from '../db/rarityMap';
...
export function buildCatalogFromApiSkins(apiSkins: ApiSkin[]): Collection[] {
  ...
  for (const skin of apiSkins) {
    ...
    collectionsMap.get(collectionId)!.items.push(...expandSkinVariants(skin, collectionId));
  }
